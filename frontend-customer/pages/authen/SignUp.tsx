...
export default function SignUp({}: Props) {
	...
	const formSchema = yup.object().shape({
		...
		confirmPassword: yup
			.string()
			.oneOf([yup.ref("password")], "Mật khẩu xác nhận phải khớp với mật khẩu")
