 ...
 *     description: Login user can create categories.
 *     tags: [categories]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Login user can retrieve all categories.
 *     tags: [categories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can fetch only their own category information. Only admins can fetch other categories.
 *     tags: [categories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
