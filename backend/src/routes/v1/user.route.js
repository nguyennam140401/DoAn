...
router
  .route('/')
  .post(auth('manage_user'), validate(userValidation.createUser), userController.createUser)
...
router
  ...
  .delete(auth('manage_user'), validate(userValidation.deleteUser), userController.deleteUser);
